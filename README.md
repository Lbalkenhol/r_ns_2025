...
The `chains/` folder contains MCMC chains and best-fir points obtained using [Cobaya](https://github.com/CobayaSampler/cobaya) and [CLASS](http://class-code.net/) for $\Lambda\mathrm{CDM}\!+\!r$:
